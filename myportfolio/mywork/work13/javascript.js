...
function myfunc() {
	...
	if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' ||
		...
		b1btn.style.background = "green";
		b2btn.style.background = "green";
		b3btn.style.background = "green";
	}
		...
		b1btn.style.background = "green";
		b4btn.style.background = "green";
		b7btn.style.background = "green";
	}
		...
		b7btn.style.background = "green";
		b8btn.style.background = "green";
		b9btn.style.background = "green";
	}
